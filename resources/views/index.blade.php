        ...
        <div class="container-lg px-4">
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <canvas class="chart" id="main-chart" height="300" width="1238" style="display: block; box-sizing: border-box; height: 300px; width: 1238px;"></canvas>
              </div>
            </div>
                      ...
                      <tbody>
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('image/img/avatars/1.jpg')}}" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
                          </td>
                          <td>  
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('image/img/avatars/2.jpg')}}" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('image/img/avatars/3.jpg')}}" alt="user@email.com"><span class="avatar-status bg-warning"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('image/img/avatars/4.jpg')}}" alt="user@email.com"><span class="avatar-status bg-secondary"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('image/img/avatars/5.jpg')}}" alt="user@email.com"><span class="avatar-status bg-success"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('image/img/avatars/6.jpg')}}" alt="user@email.com"><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
