  ...
  <div class="container-fluid border-bottom px-4">
    ...
    <ul class="header-nav">
      ...
      <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
          <div class="avatar avatar-md"><img class="avatar-img" src="{{asset('image/img/avatars/8.jpg')}}" alt="user@email.com"></div>
        </a>
        <div class="dropdown-menu dropdown-menu-end pt-0">
          ...
          <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
            ...
            <form method="POST" action="{{ route('logout.user') }}" id="logout-form">
              @csrf
              <button type="submit" class="dropdown-item" id="logout-button"><svg class="icon me-2"><use xlink:href="node_modules/@coreui/icons/sprites/free.svg#cil-lock-locked"></use></svg>Logout</button>
            </form>
          </div>
      </li>
    </ul>
